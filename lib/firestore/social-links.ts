...
const COLLECTION_NAME = 'social-links';
...
export async function uploadDefaultSocialLinks(): Promise<void> {
  ...
  try {
    for (const link of defaultLinks) {
      await setDoc(doc(db, COLLECTION_NAME, link.name.toLowerCase()), link);
    }
    console.log('Default social links uploaded successfully');
  } catch (error) {
